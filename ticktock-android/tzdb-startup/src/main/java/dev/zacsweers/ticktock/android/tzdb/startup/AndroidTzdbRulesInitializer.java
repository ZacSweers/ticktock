...
public final class AndroidTzdbRulesInitializer
    implements Initializer<Class<AndroidTzdbRulesInitializer>> {

  @Override
  public Class<AndroidTzdbRulesInitializer> create(Context context) {
