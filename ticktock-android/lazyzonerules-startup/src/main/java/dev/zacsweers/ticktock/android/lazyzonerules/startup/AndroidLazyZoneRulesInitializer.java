...
public final class AndroidLazyZoneRulesInitializer
    implements Initializer<Class<AndroidLazyZoneRulesInitializer>> {

  @Override
  public Class<AndroidLazyZoneRulesInitializer> create(Context context) {
